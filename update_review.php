...
//echo $car_name . " si " . $user . " si " . $review_content;

if (isset($_POST['submit'])) {
    $review = $_POST['review'];
    if ($review != '') {
        $insert = "UPDATE reviews SET review_content='$review' WHERE username='$user'";
    ...
    <main>
        <div class="form-container">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <?php endif ?>
                <textarea name="review" rows="5" cols="45"><?= $review_content ?></textarea>
